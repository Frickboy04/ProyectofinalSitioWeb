    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
		 ...
		 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Detalle de ordenes</strong> </h3></center>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				...
				<a class="btn btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="click for delete" onclick="return confirm('eliminar orden?')">
