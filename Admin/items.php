    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Shopping LITE - Administrator Panel</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                <li class="active"><a href="index.php"> &nbsp; &nbsp; &nbsp; Inicio</a></li>
					<li><a data-toggle="modal" data-target="#uploadModal"> &nbsp; &nbsp; &nbsp; Subir productos</a></li>
					<li><a href="items.php"> &nbsp; &nbsp; &nbsp; Adminsitración</a></li>
					<li><a href="customers.php"> &nbsp; &nbsp; &nbsp; Admin. de clientes</a></li>
					<li><a href="orderdetails.php"> &nbsp; &nbsp; &nbsp; Ordenes</a></li>
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Administración</strong> </h3></center>
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				...
				<center> <img src="item_images/<?php echo $item_image; ?>" class="img img-rounded"  width="50" height="50" /></center>
				 ...
				 <a class="btn btn-info" href="edititem.php?edit_id=<?php echo $row['item_id']; ?>" title="click for edit" onclick="return confirm('Editar producto?')"><span class='glyphicon glyphicon-pencil'></span> Editar</a> 
				
                  <a class="btn btn-danger" href="?delete_id=<?php echo $row['item_id']; ?>" title="click for delete" onclick="return confirm('eliminar producto?')"><span class='glyphicon glyphicon-trash'></span> Eliminar</a>
