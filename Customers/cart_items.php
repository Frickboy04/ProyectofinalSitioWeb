    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Shopping LITE</a>
            </div>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="fa fa-cart-plus"></span> Mi carrito</h3></center>
        </div>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
			...
			?>
                <tr>
				 ...
				 <td>
                  ...
                  <a class="btn btn-block btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="click for delete" onclick="return confirm('deseas eliminarlo?')"><span class='glyphicon glyphicon-trash'></span> elimianr</a>
		...
		echo "<td>";
		echo "<a class='btn btn-block btn-success' href='?update_id=".$user_id."' ><span class='glyphicon glyphicon-shopping-cart'></span> Pagar</a>";
		echo "</td>";
