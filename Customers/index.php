        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a data-toggle="modal" data-target="#setAccount"> &nbsp; <span class='fa fa-gear'></span> Accouuunt Settings</a></li>
...
<!-- #my-carousel-->
		...
		<br />
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2019 Shopping LITE| All Rights Reserved |  Design by : Anthon
          ...
          <div class="modal-dialog modal-sm">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-block btn-success btn-md" name="user_save">Saaaaaaaaaaave</button>
